...
DWORD WINAPI HackThread(HMODULE hModule)
{
	...
	while (!GetAsyncKeyState(VK_DELETE))
	{
		...
		//Press 5 for One Hit Kill Hack
		if (GetAsyncKeyState(VK_NUMPAD5) & 1)
		{
			funcHook("oneHit", gameLogicAddr);
			//magmarok
			//mem::Patch((BYTE*)(gameLogicAddr + 0x3CDD8), (BYTE*)"\xC1\xE1\x30", 3);
			//funcHook("magma", gameLogicAddr);
			////angry bear health = 1
			//mem::Patch((BYTE*)(gameLogicAddr + 0x4B06), (BYTE*)"\xC7\x41\x30\x01\x00", 5);
			//mem::Patch((BYTE*)(gameLogicAddr + 0x4970), (BYTE*)"\xB8\x01\x00", 3);
			////bear health = 1
			//mem::Patch((BYTE*)(gameLogicAddr + 0x61AE), (BYTE*)"\xC7\x47\x30\x01", 4);
			//mem::Patch((BYTE*)(gameLogicAddr + 0x61AE), (BYTE*)"\xB8\x01", 2);
			//cow health = 1
